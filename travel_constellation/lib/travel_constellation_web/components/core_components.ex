defmodule TravelConstellationWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TravelConstellationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TravelConstellationWeb.Gettext, "errors", msg, opts)
    end
  end
